...
'''
'''
Adapt from https://github.com/willettk/common_language/blob/master/bijective_map.py
delete both-work words
rare spellings are orthodoxed (rare us-> common uk or vice versa).
'''
orthodox = [
